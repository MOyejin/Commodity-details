...
+ (void)setNavigationBarColorWithAlpha:(float)alpha {
    ...
    //MARK: 设置Title 的 Color 和 alpha  自己添加
    [self setTintColor:[[UIColor blackColor] colorWithAlphaComponent:alpha]];
    
//    [self setTintColor:[UIColor colorWithRed:110 / 255.0 green:101 / 255.0 blue:101 / 255.0 alpha:alpha]];
